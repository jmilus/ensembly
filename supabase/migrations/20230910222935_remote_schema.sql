...
CREATE OR REPLACE FUNCTION "public"."create_new_user_profile"("user_email" "text") RETURNS "void"
    LANGUAGE "plpgsql"
    AS $$
begin
  insert into public."Profile" ("email", tenant, member)
  (SELECT user_email AS "email", m.tenant AS tenant, m.id AS member
    FROM "EmailAddress" e JOIN "Member" m ON "EmailAddress".member = m.id
    WHERE e.email = user_email);
end;
$$;

ALTER FUNCTION "public"."create_new_user_profile"("user_email" "text") OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."EnsembleMembership" (
    ...
    "statusDate" timestamp with time zone DEFAULT ("now"() AT TIME ZONE 'utc'::"text") NOT NULL,
    "statusNote" "text"
);
...
ALTER TABLE ONLY "public"."Ensemble"
    ADD CONSTRAINT "Ensemble_name_key" UNIQUE ("name");
...
ALTER TABLE ONLY "public"."SecurityRole"
    ADD CONSTRAINT "Security_name_key" UNIQUE ("role");
...
CREATE UNIQUE INDEX "Member_uniqueName" ON "public"."Member" USING "btree" ("firstName", "middleName", "lastName", "suffix");
...
ALTER TABLE ONLY "public"."Address"
    ADD CONSTRAINT "Address_type_fkey" FOREIGN KEY ("type") REFERENCES "public"."AddressType"("id") ON DELETE SET NULL;
...
ALTER TABLE ONLY "public"."Ensemble"
    ADD CONSTRAINT "Ensemble_type_fkey" FOREIGN KEY ("type") REFERENCES "public"."EnsembleType"("id") ON DELETE SET NULL;
...
ALTER TABLE ONLY "public"."EventModel"
    ADD CONSTRAINT "EventModel_location_fkey" FOREIGN KEY ("location") REFERENCES "public"."Address"("id") ON DELETE SET NULL;
...
ALTER TABLE ONLY "public"."EventModel"
    ADD CONSTRAINT "EventModel_type_fkey" FOREIGN KEY ("type") REFERENCES "public"."EventType"("id") ON DELETE SET NULL;

ALTER TABLE ONLY "public"."Event"
    ADD CONSTRAINT "Event_location_fkey" FOREIGN KEY ("location") REFERENCES "public"."Address"("id") ON DELETE SET NULL;
...
ALTER TABLE ONLY "public"."LineupAssignment"
    ADD CONSTRAINT "LineupAssignment_lineup_fkey" FOREIGN KEY ("lineup") REFERENCES "public"."Lineup"("id");
...
ALTER TABLE ONLY "public"."Member"
    ADD CONSTRAINT "Member_eyes_fkey" FOREIGN KEY ("eyes") REFERENCES "public"."EyeColor"("id");

ALTER TABLE ONLY "public"."Member"
    ADD CONSTRAINT "Member_hair_fkey" FOREIGN KEY ("hair") REFERENCES "public"."HairColor"("id");

ALTER TABLE ONLY "public"."Member"
    ADD CONSTRAINT "Member_race_fkey" FOREIGN KEY ("race") REFERENCES "public"."Race"("id");

ALTER TABLE ONLY "public"."Member"
    ADD CONSTRAINT "Member_sex_fkey" FOREIGN KEY ("sex") REFERENCES "public"."Sex"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."PhoneNumber"
    ADD CONSTRAINT "PhoneNumber_type_fkey" FOREIGN KEY ("type") REFERENCES "public"."PhoneType"("id") ON DELETE SET NULL;

ALTER TABLE ONLY "public"."Profile"
    ADD CONSTRAINT "Profile_member_fkey" FOREIGN KEY ("member") REFERENCES "public"."Member"("id");

ALTER TABLE ONLY "public"."Profile"
    ADD CONSTRAINT "Profile_role_fkey" FOREIGN KEY ("role") REFERENCES "public"."SecurityRole"("id");
...
GRANT ALL ON FUNCTION "public"."create_new_user_profile"("user_email" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."create_new_user_profile"("user_email" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."create_new_user_profile"("user_email" "text") TO "service_role";
